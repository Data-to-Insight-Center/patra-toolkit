...
class TestGitHubStore(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.github_token = "dummy_token"

    def setUp(self):
        self.mc = ModelCard(
            name="ResNetGitHubTest",
            version="1.0",
        ...
        self.mc.ai_model = AIModel(
            name="TestResNetGitHub",
            version="1.0",
            description="Sample ResNet model for testing on GitHub",
            owner="test-user",
            location="",
            license="Apache-2.0",
            framework="pytorch",
    ...
    def test_submit_full_submission(self, mock_submit):
        ...
        mock_response = {
            "success": True,
            "model_id": "test-user/ResNetGitHubTest_1.0",
            "model_url": "https://github.com/test-user/ResNetGitHubTest_1.0/blob/main/model.pt"
        }
        ...
        def side_effect(*args, **kwargs):
            self.mc.ai_model.location = "https://github.com/test-user/ResNetGitHubTest_1.0/blob/main/model.pt"
        ...
        self.assertEqual(self.mc.ai_model.location,
                         "https://github.com/test-user/ResNetGitHubTest_1.0/blob/main/model.pt")
    ...
    def test_submit_modelcard_only(self, mock_post):
        ...
        mock_response = MagicMock(
            status_code=200,
            json=lambda: {"success": True, "model_id": "test-user/ResNetGitHubTest_1.0"}
        )
        ...
        class TestModelCard(ModelCard):
            def submit(self, **kwargs):
                ...
                if not kwargs.get('model'):
                    return {"success": True, "model_id": "test-user/ResNetGitHubTest_1.0"}
